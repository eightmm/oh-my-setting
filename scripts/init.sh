...
echo "- Distill verified repo lessons (build quirks, test invocation, domain rules) into project skills: 'oms skill-forge add --name oms-NAME' — evidence-backed only, all three CLIs load them natively."
if [ "$style" = "ml" ]; then
