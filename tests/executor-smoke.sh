...
test_assets() {
  ...
  grep -Fq Deprecated "$ROOT/workflows/spec-first.md" || fail "spec workflow not deprecated"
  grep -Fq Deprecated "$ROOT/workflows/slurm-hpc.md" || fail "slurm workflow not deprecated"
  grep -Fq Deprecated "$ROOT/workflows/new-server.md" || fail "server workflow not deprecated"
